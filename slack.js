        ...
        if (docs.length > 0&&!req.body.event.bot_id) {
          ...
          if (lastBotMessageIndex !== 0) {
            if (lastMessage && lastMessage === 'daily') {
              ...
              await this.sendMessage(docs[0]._id,req.body.event.user,BotMessages[botMessageIndex],botMessageIndex===0?'daily':BotMessages[botMessageIndex],req.body.event.channel);
